...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .subtitle { margin: 0 0 22px; color: var(--text-muted); font-size: 0.92rem; }
        ...
        .topbar h1 { margin: 0; font-size: clamp(1.2rem, 2.1vw, 1.5rem); }
        .topbar p { margin: 3px 0 0; color: var(--text-muted); font-size: 0.93rem; }
        ...
        .hero h2 { margin: 0; font-size: clamp(1.3rem, 2.4vw, 2rem); }
        .hero p { margin: 8px 0 0; color: rgba(255, 255, 255, 0.88); }

        .hero-actions { margin-top: 16px; display: flex; gap: 10px; flex-wrap: wrap; }
        .hero .btn-primary { background: #ffffff; color: #0f6b78; }
        .hero .btn-ghost { background: rgba(255, 255, 255, 0.16); border-color: rgba(255, 255, 255, 0.4); color: #fff; }
        ...
        .kpi-title { margin: 0 0 6px; color: var(--text-muted); font-size: 0.85rem; }
        .kpi-value { margin: 0; font-size: 1.35rem; font-weight: 800; }
        .kpi-sub { margin: 6px 0 0; color: var(--text-muted); font-size: 0.85rem; }
        ...
        .convenio-list { display: grid; gap: 10px; }
        ...
        .convenio-item h4 { margin: 0 0 7px; font-size: 0.95rem; }
        .convenio-meta { margin: 0; color: var(--text-muted); font-size: 0.86rem; }
        ...
        .timeline-item strong { display: block; font-size: 0.9rem; margin-bottom: 3px; }
